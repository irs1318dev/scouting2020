...
export const MEASURES: Measure[] = [
  ...
  { id: 20, type: 'ENUM', attempts: 0, task_id:0, successes: 0,  actor: actors.robot, phase: phases.teleop, task_name: 'Defense' },
  { id: 35, type: 'ENUM', attempts: 0, task_id:0, successes: 0,  actor: actors.robot, phase: phases.teleop, task_name: 'Defended Against' },
